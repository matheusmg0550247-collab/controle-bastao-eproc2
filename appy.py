...
# ============================================
# 2. FUNÇÕES AUXILIARES GLOBAIS (Verifique a Indentação!)
# ============================================
...
def init_session_state():
    ...
    if not st.session_state.bastao_queue and checked_on:
        ...
        master_order_from_state = persisted_state.get('master_order', []) # Try to use previous order
...
def check_and_assume_baton():
    ...
    elif next_holder: should_have_baton = next_holder
...
# ============================================
# 3. FUNÇÕES DE CALLBACK GLOBAIS (Verifique Indentação!)
# ============================================
...
rerun_needed_after_baton_check = False
if not holder_exists and st.session_state.bastao_queue and eligible_exists:
    ...
    if not st.session_state.get('_assign_attempt', False):
        ...
        if check_and_assume_baton():
            ...
            rerun_needed_after_baton_check = True # Mark for rerun after layout
    else:
...
# Trigger rerun if baton was assigned during render check
if rerun_needed_after_baton_check:
    st.rerun()
