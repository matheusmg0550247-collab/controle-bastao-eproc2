...
def generate_app_code(emoji, webhook_relatorio, webhook_bastao, public_url):
    ...
    app_code_lines = [
        ...
        "",
        "    active_people = set(st.session_state.bastao_queue) | st.session_state.completed_this_cycle",
        "    for nome in CONSULTORES:",
        ...
        "        if not st.session_state.initial_cycle_members: st.session_state.initial_cycle_members.add(consultor)",
        "    else:",
        ...
        "            else: display = f'**{nome}** :green-background[Disponível]'",
